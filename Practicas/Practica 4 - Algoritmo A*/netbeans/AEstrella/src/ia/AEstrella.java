...
public class AEstrella extends PApplet {
    ...
    class Mosaico {
        ...
        void calculaHeuristica(Mosaico meta) {
            /**
             * IMPLEMENTACION HINT: calculen la distancia de este mosaico hacia
             * el mosaico meta y luego multipliquenlo por 10 para que el valor
             * sea significativo. tampoco deberia haber valores negativos
             */
            // Se saca distancia vertical y horizonatl respecto al mosaico actual
            // y la meta. Se saca el valor absoluto y se multiplica por 10.
    ...
    class Algoritmo {
        ...
        private HashSet<Mosaico> listaCerrada;
        ...
        void expandeNodoSiguiente() {
            ...
            // Saco nodo actual de la lista abierta.
            nodoActual = listaAbierta.poll();
            //  Lo agrego a la lista cerrada.
            ...
            if (nodoActual.estado.renglon == estadoFinal.renglon
                ...
                // Pintar la ruta del nodo actual al padre inicial (mosaíco inicial)
